...
def get_rappers():
    with open("rappers.txt", "r") as f:
        ...
        for line in f:
            ...
            rappers[year].append(line.strip())
...
def main():
    ...
    # main_folder = "Results"
    for year, artists in artist_list.items():
        main_folder = "Results" + str(year)
        fetch_songs(artists, 10, main_folder)
